...
public class LogitechGSDK {
    ...
    /// <summary>
    /// To the right of the left most button
    /// </summary>
    public const int LOGI_LCD_MONO_BUTTON_1 = 0x00000002;

    /// <summary>
    /// To the left of the right most button
    /// </summary>
    ...
    /// </summary>
    /// <param name="friendlyName">Name of your applet, you can't change it after initialization.</param>
    /// <param name="lcdType">
    ///     <para>
    ...
    private static IntPtr LogiGkeyGetMouseButtonString(int buttonNumber) {
    ...
    private static IntPtr LogiGkeyGetKeyboardGkeyString(int gkeyNumber, int modeNumber) {
